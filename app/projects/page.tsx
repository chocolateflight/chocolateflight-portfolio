...
import tictac from '../../resources/images/tic-tac-toe.png';
    ...
    <main className='md:h-full'>
      <div className='h-full flex flex-col items-center justify-center'>
        <div className='grid grid-cols-1 gap-4 overflow-visible pt-2 md:grid-cols-2 md:grid-rows-2 md:max-w-[1100px] md:gap-y-8'>
          ...
          {/* <div className='flex flex-col items-center gap-4 overflow-visible md:flex-row md:max-w-[1100px] border-2'>
        </div> */}
        </div>
      </div>
    </main>
